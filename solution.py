...
def naked_twins(values):
    ...
    for row in row_units:
        for box in row:
            if(len(values[box]) == 2):
                places = [place for place in row if values[place] == values[box] and place != box]
                if (len(places) == 1):
    ...
    for col in column_units:
        for box in col:
            if(len(values[box]) == 2):
                places = [place for place in col if values[place] == values[box] and place != box]
                if (len(places) == 1):
                    for digit in values[box]:
    ...
    for square in square_units:
        for box in square:
            if(len(values[box]) == 2):
                places = [place for place in square if values[place] == values[box] and place != box]
                if (len(places) == 1):
                    for digit in values[box]:
